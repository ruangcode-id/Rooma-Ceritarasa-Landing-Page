...
const Footer = () => {
  return (
    <footer className="bg-[#fcfbf9] bg-texture text-gray-800 pt-20 pb-10 px-6 border-t border-black/10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="#" className="text-gray-600 hover:text-primary font-medium transition-colors">Our Menu</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary font-medium transition-colors">About Us</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary font-medium transition-colors">Chef's Table</a></li>
            <li><a href="#" className="text-gray-600 hover:text-primary font-medium transition-colors">Private Events</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-600 font-medium">
            <li className="flex items-start">
              ...
              <span>123 Culinary Boulevard,<br />Jakarta, ID 12190</span>
            </li>
            ...
            <li className="flex items-center">
              ...
              <span>hello@loremipsum.com</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-600">
            <li className="flex justify-between border-b border-gray-200 pb-2">
              <span>Mon - Thu</span>
              <span className="font-semibold text-gray-800">11:00 AM - 10:00 PM</span>
            </li>
            <li className="flex justify-between border-b border-gray-200 pb-2">
              <span>Fri - Sat</span>
              <span className="font-semibold text-gray-800">11:00 AM - 11:30 PM</span>
            </li>
            <li className="flex justify-between">
              <span>Sunday</span>
              <span className="font-semibold text-gray-800">10:00 AM - 9:00 PM</span>
            </li>
          </ul>
        </div>
